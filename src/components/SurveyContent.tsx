...
class SurveyContent extends React.Component<RouteComponentProps> {
  handleSubmit() {
    this.props.history.push('/survey-home');
  }
    ...
    return (
      <div className="desert desert-up">
        <div className="content">
          ...
          <form id="survey-form" onSubmit={this.handleSubmit.bind(this)}>
            <div className="chunk">
              <label
                className="lbl"
                htmlFor="name"
